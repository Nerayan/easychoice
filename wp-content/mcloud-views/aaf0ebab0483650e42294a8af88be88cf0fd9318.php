                ...
                <div class="ilab-settings-button">
                    <?php if(!empty($tool->actions())): ?>
                        <div class="ilab-settings-batch-tools">
                            ...
                            <a class="button ilab-ajax-button" data-ajax-action="<?php echo e(str_replace('-','_',$key)); ?>" href="#"><?php echo e($action['name']); ?></a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    <?php endif; ?>
                    <?php if($tool->hasEnabledBatchTools()): ?>
                        <div class="ilab-settings-batch-tools">
                        <?php $__currentLoopData = $tool->enabledBatchToolInfo(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $batchTool): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a class="button" href="<?php echo e($batchTool['link']); ?>"><?php echo e($batchTool['title']); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    <?php endif; ?>
                    <?php submit_button(); ?>
