...
return [
	...
	"plugins" => [
		'master-slider/master-slider.php' => "\\ILAB\\MediaCloud\\Tools\\Integrations\\PlugIns\\MasterSliderIntegration",
		'ml-slider/ml-slider.php' => "\\ILAB\\MediaCloud\\Tools\\Integrations\\PlugIns\\MetaSliderIntegeration",
		'ml-slider-pro/ml-slider-pro.php' => "\\ILAB\\MediaCloud\\Tools\\Integrations\\PlugIns\\MetaSliderIntegeration",
		'smart-slider-3/smart-slider-3.php' => "\\ILAB\\MediaCloud\\Tools\\Integrations\\PlugIns\\SmartSliderIntegration",
		'ultimate-member/ultimate-member.php' => "\\ILAB\\MediaCloud\\Tools\\Integrations\\PlugIns\\UltimateMemberIntegration",
		'powerpress/powerpress.php' => "\\ILAB\\MediaCloud\\Tools\\Integrations\\PlugIns\\BlubrryIntegration",
		'profilegrid-user-profiles-groups-and-communities/profile-magic.php' => "\\ILAB\\MediaCloud\\Tools\\Integrations\\PlugIns\\ProfileGridIntegration",
	],
	"classes" => [
		"\\BuddyPress" => "\\ILAB\\MediaCloud\\Tools\\Integrations\\PlugIns\\BuddyPress\\BuddyPressIntegration",
		"\\C_NextGEN_Bootstrap" => "\\ILAB\\MediaCloud\\Tools\\Integrations\\PlugIns\\NextGenGallery\\NextGenGalleryIntegration",
		"\\Elementor\\Plugin" => "\\ILAB\\MediaCloud\\Tools\\Integrations\\PlugIns\\Elementor\\ElementorIntegration",
		"\\FooGallery" => "\\ILAB\\MediaCloud\\Tools\\Integrations\\PlugIns\\FooGalleryIntegration",
		"\\SFWD_LMS" => "\\ILAB\\MediaCloud\\Tools\\Integrations\\PlugIns\\LearnDashIntegration",
	],
	"settings" => [
			...
			"ilab-media-cloud-elementor" => [
				...
				"options" => [
					"mcloud-elementor-auto-update" => [
						...
						"description" => "Enabling this will auto-update your Elementor page data to insure that any image reference is pointed to the right image URL.  This update is only triggered after performing a migration or import using one of the Media Cloud batch tools.",
						"display-order" => 1,
						"type" => "checkbox",
						"default" => false,
					],
