...
@fs_ignore /vendor/, /public/, /external/, /docs/
@fs_premium_only  /classes/Tools/Assets, /classes/Tools/Browser, /classes/Tools/Storage/Batch, /classes/Tools/Integrations, /classes/Tools/Glide, /classes/Tools/ImageSizes, /classes/Tools/MediaUpload, /classes/Tools/Network, /classes/Vision/Driver/GoogleCloudVision, /config/assets.config.php, /config/integrations.config.php, /config/browser.config.php, /config/glide.config.php, /config/image-sizes.config.php, /config/media-upload.config.php, /config/network.config.php, /config/vision/google.config.php, /views/upload, /views/storage/browser.blade.php, /views/storage/browser-header.blade.php, /views/storage/browser-table.blade.php, /views/integrations, /views/image-sizes, /views/base/multisite-landing.blade.php
*/
